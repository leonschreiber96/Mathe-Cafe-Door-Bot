...
export const WD_COL = [
  cssVar("--wd-mon"), cssVar("--wd-tue"), cssVar("--wd-wed"), cssVar("--wd-thu"),
  cssVar("--wd-fri"), cssVar("--wd-sat"), cssVar("--wd-sun"),
];
...
export function baseOpts(extra = {}) {
  return Object.assign({
    ...
    plugins: {
      ...
      tooltip: {
        backgroundColor: COL.paper, borderColor: COL.ink, borderWidth: 1,
        titleColor: COL.ink, bodyColor: COL.inkdim, padding: 8,
        displayColors: false, cornerRadius: 0, titleFont: { weight: "700" },
      },
    },
  }, extra);
}
