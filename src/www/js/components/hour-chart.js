/* components/hour-chart.js — <door-hour> (Fig. 7)
 *
 * Average open-% by hour of day over the whole current period, as a printed
 * hatch-filled line. Logic-only: update(byHour).
 */
    ...
    const cfg = {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: COL.open, borderWidth: 1.6,
          fill: true, backgroundColor: hatch(COL.open, 1, 6, 0.8),
